...
const Invoice = () => {
  ...
  const status = total - invicedata.Advance;
  ...
  return (
    <>
      ...
      <div className="printbutton d-flex justify-content-around">
        <button className="btn btn-success " onClick={printinvice1}>
          {" "}
          Original Print
        </button>
      </div>

      <div className="bill-invoice" id="printinvice21">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              {status == 0 ? <td>PAID</td> : <td>No Paid</td>}
            </tr>
          </tbody>
          <tfoot>
            <tr>
